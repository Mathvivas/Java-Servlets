package br.maua.citiesapi.cities.service;
...
import br.maua.citiesapi.utils.StringLocationUtil;
...
public class DistanceService {
    ...
    public Double distanceUsingMath(final Long city1, final Long city2, final EarthRadius unit) {
        ...
        final Double[] location1 = StringLocationUtil.transform(cities.get(0).getGeolocation());
        final Double[] location2 = StringLocationUtil.transform(cities.get(1).getGeolocation());
